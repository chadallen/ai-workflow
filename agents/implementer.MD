...
If the task involves iOS-specific features, native patterns, SwiftUI, UIKit, App Store, or anything platform-specific, invoke the `ios-developer` skill before writing code.
